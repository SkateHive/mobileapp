...
export function Trending({ refreshTrigger = 0 }: FeedProps) {
  ...
  const ListHeaderComponent = React.useCallback(
    () => <Text style={styles.headerText}>Trending Posts</Text>,
    []
  );
